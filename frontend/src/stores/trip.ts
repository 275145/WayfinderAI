...
function cloneTrip<T>(value: T): T {
  return JSON.parse(JSON.stringify(value))
}

function sanitizeTripPlan(plan: TripPlanResponse): TripPlanResponse {
...
function normalizeTrip(trip: TripPlanResponse): TripListItem {
